...
export const IntelligenceWorkspace: React.FC = () => {
    ...
    const handleToggleSave = (rec: IntelligenceRecord, e: React.MouseEvent) => {
        ...
        const exists = savedReportIds.includes(id);
        const next = exists ? savedReportIds.filter((x) => x !== id) : [...savedReportIds, id];
        setSavedReportIds(next);
        try {
    ...
    return (
        <div className="h-full flex flex-col p-4 lg:p-6 space-y-6 max-w-[1680px] mx-auto w-full overflow-y-auto custom-scrollbar bg-[#F4F7FB]">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                {/* Authoritative Date Range Selector & Actions */}
                        ...
                        <div className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
                                {paginatedRecords.map((record) => {
                                    ...
                                    const isSaved = savedReportIds.includes(recordId);
